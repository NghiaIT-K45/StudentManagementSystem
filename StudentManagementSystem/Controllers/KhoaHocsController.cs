...
namespace StudentManagementSystem.Controllers
{
    public class KhoaHocsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaKhoaHoc,TenKhoaHoc,MoTa")] KhoaHoc khoaHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaKhoaHoc,TenKhoaHoc,MoTa")] KhoaHoc khoaHoc)
        {
